...
public class MainActivity extends AppCompatActivity
    ...
    MenuItem first_time ;
    MenuItem first_dist ;
    MenuItem second_time ;
    MenuItem second_dist;
    MenuItem third_time ;
    MenuItem third_dist;
    MenuItem logout;
    MenuItem clear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first_time = menu.findItem(R.id.first_time);
        first_dist = menu.findItem(R.id.first_dist);
        second_time = menu.findItem(R.id.second_time);
        second_dist = menu.findItem(R.id.second_dist);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.info); {
            Log.d("optionitemselected", item.getItemId()+"");
        ...
        builder.setPositiveButton("예",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        total_distance = distance_between_start_and_nns+ distance_between_nns_and_nnd + distance_between_nnd_and_dest;
                        taxi_fee = calculate_taxi_fee(total_distance);
    ...
    private int calculate_taxi_fee(int distance) {
        if (distance<2000) {return 3300;}
        else {
            int dx = (distance-2000)/133;
            return 3300+(dx*100);
        }
    }
    ...
    private void setInformation() {
        ...
        second_dist.setTitle(distance_between_nns_and_nnd+" M");
        third_time.setTitle(minute_to_dest+" 분");
        third_dist.setTitle(distance_between_nnd_and_dest+" M");
    }
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(36.374160, 127.365790);
